...
export default function App() {
  ...
  const handleConnect = async (): Promise<void> => {
    ...
    try {
      ...
      setErrorMessage(error instanceof Error ? error.message : '接続エラー');
      Alert.alert('接続エラー', error instanceof Error ? error.message : '不明なエラー');
    }
  };
  ...
  const handleDisconnect = async (): Promise<void> => {
    try {
      ...
      setErrorMessage(error instanceof Error ? error.message : '切断エラー');
    }
  };

  // コマンド送信
  const handleCommand = async (command: Partial<DroneCommand>): Promise<void> => {
    ...
    try {
      ...
      setErrorMessage(error instanceof Error ? error.message : '送信エラー');
      Alert.alert('送信エラー', error instanceof Error ? error.message : '不明なエラー');
    }
  };
  ...
  const handleStop = async (): Promise<void> => {
    try {
      ...
      setErrorMessage(error instanceof Error ? error.message : '停止エラー');
    }
  };
